export default {
  ...
  setting: {
    ...
    system: {
      ...
      apiToken: 'API Token',
      apiTokenHint: 'Set the token value used when external requests access MovieStation API',
      ...
      moviePilotAutoUpdate: 'Auto Update MovieStation',
      moviePilotAutoUpdateHint: 'Automatically update MovieStation to the latest release version when restarting',
    ...
    site: {
      ...
      serviceAddressPlaceholder: 'https://movie-station.org/cookiecloud',
      serviceAddressHint: 'Remote CookieCloud service address, format: https://movie-station.org/cookiecloud',
      userKey: 'User KEY',
      ...
      autoSyncIntervalHint:
        'Time interval for automatically syncing site cookies from CookieCloud server to MovieStation',
    ...
    search: {
      ...
      downloadLabelPlaceholder: 'MOVIESTATION',
    },
    directory: {
      storage: 'Storage',
