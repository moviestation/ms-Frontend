export default {
  ...
  setting: {
    ...
    system: {
      ...
      apiToken: 'API令牌',
      apiTokenHint: '設置外部請求MovieStation API時使用的token值',
      ...
      moviePilotAutoUpdate: '自動更新MovieStation',
      moviePilotAutoUpdateHint: '重啟時自動更新MovieStation到最新發行版本',
    ...
    site: {
      ...
      serviceAddressHint: '遠端CookieCloud服務地址，格式：https://movie-station.org/cookiecloud',
      userKey: '用戶KEY',
      userKeyHint: 'CookieCloud瀏覽器插件生成的用戶KEY',
      e2ePassword: '端對端加密密碼',
      e2ePasswordHint: 'CookieCloud瀏覽器插件生成的端對端加密密碼',
      autoSyncInterval: '自動同步間隔',
      autoSyncIntervalHint: '從CookieCloud服務器自動同步站點Cookie到MovieStation的時間間隔',
