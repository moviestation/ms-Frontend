export default {
  ...
  setting: {
    ...
    system: {
      ...
      apiToken: 'API令牌',
      apiTokenHint: '设置外部请求MovieStation API时使用的token值',
      ...
      moviePilotAutoUpdate: '自动更新MovieStation',
      moviePilotAutoUpdateHint: '重启时自动更新MovieStation到最新发行版本',
    ...
    site: {
      ...
      serviceAddressHint: '远端CookieCloud服务地址，格式：https://movie-station.org/cookiecloud',
      userKey: '用户KEY',
      userKeyHint: 'CookieCloud浏览器插件生成的用户KEY',
      e2ePassword: '端对端加密密码',
      e2ePasswordHint: 'CookieCloud浏览器插件生成的端对端加密密码',
      autoSyncInterval: '自动同步间隔',
      autoSyncIntervalHint: '从CookieCloud服务器自动同步站点Cookie到MovieStation的时间间隔',
